            ...
            if(txtMaDG.Text.Length>0 && txtTenDG.Text.Length>0 && txtDiaChi.Text.Length>0 && isNumberSDT==true && dtmNgaySinh.Text.Length>0 && cboGioiTinh.Text.Length>0 && txtTenTK.Text.Length>0 && txtMK.Text.Length>0 && cboLoaiDG.Text.Length>0)
            {
                ...
                else if(xuly==1)
                {
                    try
                    {
                        ...
                        capnhatdongsql = "update tblDocGia set TenDG=N'" + txtTenDG.Text + "',GioiTinhDG=N'" + cboGioiTinh.Text + "',NgaySinhDG='" + dtmNgaySinh.Text + "',DiaChiDG=N'" + txtDiaChi.Text + "',SDTDG='" + txtSoDT.Text + "',LoaiDG=N'" + cboLoaiDG.Text + "',GhiChu=N'" + txtGhiChu.Text + "',TenTaiKhoanDG='" + txtTenTK.Text + "',MatKhauDG='" + frmConfig.md5_Hash(txtMK.Text) + "' where MaDG='" + txtMaDG.Text + "'";
